...
export const DriverLoginScreen: React.FC<DriverLoginScreenProps> = ({
  ...
  const handleLogin = () => {
    if (!identifier.trim()) {
      setErrorMsg('Please enter your license number, email, or vehicle plate');
      return;
    }
    if (!password) {
        ...
        >
          ...
          <View style={styles.topNav}>
            ...
            <View style={styles.portalPill}>
              <Text style={styles.topNavTag}>DRIVER PORTAL</Text>
            </View>
          ...
          <View style={styles.headerSection}>
            <View style={styles.stampBadge}>
              <Text style={styles.badgeTag}>VEHICLE PARTNER ACCESS</Text>
            </View>
            <Text style={styles.heroTitle}>Login</Text>
          </View>

          {/* Partner Highlight Banner with Clear Boundaries */}
          <View style={styles.hardwareBanner}>
            <View style={styles.hardwareBadge}>
              <Text style={styles.hardwareBadgeText}>DIRECT PAYOUTS</Text>
            </View>
            <View style={styles.hardwareTextCol}>
              <Text style={styles.hardwareTitle}>Automated Bank Transfers</Text>
              <Text style={styles.hardwareDesc}>
                Connect to verified advertising campaigns and receive direct bank disbursements.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.formSection}>
            ...
            <View style={styles.inputGroup}>
              <Text style={styles.inputLabel}>VEHICLE REGISTRATION, LICENSE OR EMAIL</Text>
              <View style={[styles.inputBox, activeInput === 'id' && styles.inputBoxActive]}>
                <TextInput
                  style={styles.textInput}
                  placeholder="e.g. LD74 DOO or PHV-788920-LON"
            ...
            >
              <Text style={styles.demoFillBtnText}>⚡ Demo Login (LD74 DOO)</Text>
            </TouchableOpacity>
          </View>

          {/* Footer Register Link */}
          <View style={styles.footerRow}>
            <Text style={styles.footerText}>New driver or fleet owner?</Text>
            <TouchableOpacity activeOpacity={0.7} onPress={onNavigateToRegister}>
              <Text style={styles.registerBottomLink}> Register Vehicle</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
